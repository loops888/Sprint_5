...
class TestPersonalAccount:
    ...
    def test_click_on_personal_account_personal_page_visible(self, login):
        ...
        WebDriverWait(login, 2).until(expected_conditions.visibility_of_element_located((Locators.PERSONAL_INFO)))
        assert login.find_element(*Locators.PERSONAL_INFO).is_displayed()
    ...
    def test_click_on_exit_from_account_main_page_is_shown(self, login):
        ...
        WebDriverWait(login, 2).until(expected_conditions.visibility_of_element_located((Locators.LOGIN_WINDOW)))
